...
#[derive(Args)]
pub struct New {
    #[arg(name = "TARGETNAME",required= true, long = "target", value_parser = ["solana", "polkadot", "evm", "weilliptic"], help = "Target to build for [possible values: solana, polkadot]", num_args = 1, hide_possible_values = true)]
...
pub struct TargetArg {
    #[arg(name = "TARGET",required= true, long = "target", value_parser = ["solana", "polkadot", "evm", "weilliptic"], help = "Target to build for [possible values: solana, polkadot]", num_args = 1, hide_possible_values = true)]
    pub name: String,
...
pub struct CompileTargetArg {
    #[arg(name = "TARGET", long = "target", value_parser = ["solana", "polkadot", "evm", "soroban", "weilliptic"], help = "Target to build for [possible values: solana, polkadot]", num_args = 1, hide_possible_values = true)]
...
pub(crate) fn target_arg<T: TargetArgTrait>(target_arg: &T) -> Target {
    ...
    let target = match target_name.as_str() {
        ...
        "weilliptic" => solang::Target::Weilliptic,
        _ => unreachable!(),
    };
