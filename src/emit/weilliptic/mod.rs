...
pub const PUT_CONTRACT_DATA: &str = "put_contract_data";
pub const GET_CONTRACT_DATA: &str = "get_contract_data";
...
impl WeillipticTarget {
    ...
    fn emit_functions_with_spec<'a>(
        ...
        for (func_decl, cfg) in defines {
            emit_cfg(&mut WeillipticTarget, binary, contract, cfg, func_decl, ns);
        }
    }
